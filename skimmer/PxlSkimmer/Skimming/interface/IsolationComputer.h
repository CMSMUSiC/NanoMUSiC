// from: https://github.com/ECOP/cmg-cmssw/blob/heppy_80X_M17/PhysicsTools/Heppy/interface/IsolationComputer.h
...
class IsolationComputer {
    public:
        ...
        float getAbsMiniIso(const reco::Candidate &cand, const double rho, bool muon) ;
    ...
    protected:
        ...
        float getMiniIsoConeSize(const double pt);
        const double getEA(const reco::Candidate &cand, bool muon);
};
