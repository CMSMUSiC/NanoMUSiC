...
process = Tools_miniAOD.prepare( runOnGen, runOnData, name, datasetpath, globalTag, updateJEC=True, readJECFromDB=False, verbosity=verbosityLvl, year=2016 )
...
process.source = cms.Source(
    ...
    fileNames = cms.untracked.vstring(
        '/store/mc/RunIISummer16MiniAODv3/DYJetsToLL_Pt-250To400_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/MINIAODSIM/PUMoriond17_94X_mcRun2_asymptotic_v3-v1/110000/D8493924-D2C3-E811-8AB8-001E6724917D.root'
        )
    )
