...
print sys.argv
name="test"
datasetpath="/SingleMuon/Run2017C-09Aug2019_UL2017-v1/MINIAOD"
...
process.source = cms.Source(
    ...
    fileNames = cms.untracked.vstring(
        '/store/data/Run2017C/SingleMuon/MINIAOD/09Aug2019_UL2017-v1/130000/01568436-74A4-EC4F-B1EB-D00E343C57C9.root'
        )
    )
