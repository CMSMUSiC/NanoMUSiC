...
print sys.argv
name="test"
datasetpath="/SingleMuon/Run2016D-17Jul2018-v1/MINIAOD"
...
process = Tools_miniAOD.prepare( runOnGen, runOnData, name, datasetpath, globalTag, year=2016, updateJEC=True, readJECFromDB=False, verbosity=verbosityLvl )
