...
class ScanResult {
    public:
        ...
        const MCBin& getMcBin() const { return mcbin; }
        double getScore() const { return score; }
        double getData() const { return data; }
        double getTotalMcEvents() const { return totalMc; }
        double getTotalMcUncert() const { return totalMcUncert; }
        double getTotalData() const { return totalData; }
        bool isIntegralScan() const { return integralScan; }
        bool isSkippedScan() const { return skippedScan; }
