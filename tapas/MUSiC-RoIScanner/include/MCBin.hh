...
class MCBin {
     ...
     * All information are stored in a way which allows to easily add a number of EventErrorCollections, resulting in the events and errors for the region of interest formed by all added bins.
     */
    public:
