...
std::vector< double > Dicer::dicePseudoData( const std::vector< MCBin >& bins,
        const unsigned int round, PriorMode prior ){
...
std::vector< double > Dicer::dicePoissonData( const std::vector< MCBin >& bins,
        const std::vector< double >& systematicShifts, PriorMode prior ){
