...
public:
   ...
   //std::map< std::string, std::vector< pxl::Particle* > > getGenParticleLists ( const pxl::EventView* EvtView ) const;
   static std::map< std::string, std::vector< pxl::Particle* > > getGenParticleLists ( const pxl::EventView* EvtView );
   std::map< std::string, std::vector< pxl::Particle* > > getParticleLists ( const pxl::EventView* EvtView,
                                                                             bool selectedOnly = false,
                                                                             std::list< std::function< void( std::map< std::string, std::vector< pxl::Particle* > >& ) > > functions = std::list< std::function< void( std::map< std::string, std::vector< pxl::Particle* > >& ) > >()
                                                                             ) const;
   // Get a map of counts for a map of particle lists as created by getParticleLists
   std::map< std::string, int > getParticleCountMap( const std::map< std::string, std::vector< pxl::Particle* > >& particleLists ) const;
  ...
  std::map< std::string, int >& getFilterMap() { return m_all_filters_map; }

   const ObjectSelector* getObjectSelector( const std::string& object ) const;
   const GenSelector* getGenSelector() const {return &m_gen_selector;};
...
private:
    ...
    void applyCutsOnObject( std::vector< pxl::Particle* > &objects,
    ...
    void applyKinematicCuts( std::vector< pxl::Particle* > &objects,
                                       const std::string& partName,
                                       const bool isSyst);
