...
public:
   ...
   void cleanEvent( std::map< std::string, std::vector< pxl::Particle* > >& particleMap,
                    bool const isRec
                    ) const;
private:
   ...
   void removeGammaEleOverlap( std::vector< pxl::Particle* > &gams,
   ...
   const std::map< std::string, std::function< void( const EventCleaning&, std::vector< pxl::Particle* >&, const bool ) > > m_self_cleaning_functions;
