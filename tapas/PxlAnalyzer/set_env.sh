...
## CSC filter file for CMSSW_7_4_X and older
## Good example of how to implement such filter files
# CSCBEAMHALOFILE=$DIR/ConfigFiles/ConfigInputs/csc2015.txt
# if [ ! -f $CSCBEAMHALOFILE ]; then
#   #uberftp grid-ftp "get pnfs/physik.rwth-aachen.de/cms/store/user/padeken/MUSiC/share/csc2015.txt.tar.gz ."
#   cp ~padeken/public/csc2015.txt.tar.gz .
#   tar -xzf csc2015.txt.tar.gz
#   mv csc2015.txt $CSCBEAMHALOFILE
#   rm csc2015.txt.tar.gz
# fi
