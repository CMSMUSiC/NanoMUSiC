...
namespace HistClass
{
static std::unordered_map<std::string, TH1D *>
    histo; /*!< Map of a string and a TH1D histogram, for easy 1D histogram handling. */
static std::unordered_map<std::string, TH2D *>
    histo2; /*!< Map of a string and a TH2D histogram, for easy 2D histogram handling. */
static std::unordered_map<std::string, THnSparseD *>
    histon; /*!< Map of a string and a THnSparseD histogram, for easy nSparse handling. */
static std::unordered_map<std::string, TNtupleD *>
    ttupple; /*!< Map of a string and a TNtupleD histogram, for easy Ntuple handling. */
static std::unordered_map<std::string, TTree *>
    trees; /*!< Map of a string and a TTree histogram, for easy tree handling. */
 ...
 */
SUPPRESS_NOT_USED_WARN static void CreateHisto(Int_t n_histos, const char *name, Int_t nbinsx, Double_t xlow,
                                               Double_t xup, TString xtitle = "")
{
 ...
 * \param[in] xtitle Optinal title of the x-axis (DEFAULT = "")
 */
SUPPRESS_NOT_USED_WARN static void CreateHisto(Int_t n_histos, const char *name, const char *particle, Int_t nbinsx,
                                               Double_t xlow, Double_t xup, TString xtitle = "")
{
    std::string _name = name;
 ...
 * \param[in] xtitle Optinal title of the x-axis (DEFAULT = "")
 */
SUPPRESS_NOT_USED_WARN static void CreateHistoUnchangedName(const char *name, Int_t nbinsx, Double_t xlow, Double_t xup,
                                                            TString xtitle = "")
{
 ...
 */
SUPPRESS_NOT_USED_WARN static void CreateHisto(const char *name, Int_t nbinsx, Double_t xlow, Double_t xup,
 ...
 * \param[in] xtitle Optinal title of the x-axis (DEFAULT = "")
 */
SUPPRESS_NOT_USED_WARN static void CreateHisto(const char *name, const char *particle, Int_t nbinsx, Double_t xlow,
                                               Double_t xup, TString xtitle = "")
{
 ...
 * \param[in] xtitle Optinal title of the x-axis (DEFAULT = "")
 */
SUPPRESS_NOT_USED_WARN static void CreateHisto(boost::basic_format<char> name, Int_t nbinsx, Double_t xlow,
                                               Double_t xup, TString xtitle = "")
{
 ...
 */
SUPPRESS_NOT_USED_WARN static void CreateHisto(const char *name, Int_t nbinsx, Double_t xlow, Double_t xup,
                                               Int_t nbinsy, Double_t ylow, Double_t yup, TString xtitle = "",
                                               TString ytitle = "")
{
                                               ...
                                               TString xtitle = "", TString ytitle = "")
{
    ...
    for (int i = 0; i < n_histos; i++)
    {
        TH2D *tmphist = new TH2D(Form("h2_%d_%s", i, _name.c_str()), Form("h2_%d_%s", i, _name.c_str()), nbinsx, xlow,
                                 xup, nbinsy, ylow, yup);
        tmphist->SetXTitle(xtitle);
        tmphist->SetYTitle(ytitle);
        tmphist->Sumw2();
 ...
 * \param[in] ytitle Optinal title of the y-axis (DEFAULT = "")
 */
SUPPRESS_NOT_USED_WARN static void CreateHisto(const char *name, Int_t nbinsx, const Double_t *xbins, Int_t nbinsy,
 ...
 */
SUPPRESS_NOT_USED_WARN static void CreateHisto(const char *name, Int_t nbinsx, Double_t xlow, Double_t xup,
                                               Int_t nbinsy, const Double_t *ybins, TString xtitle = "",
                                               TString ytitle = "")
{
    std::string dummy = Form("h2_%s", name);
 ...
 */
SUPPRESS_NOT_USED_WARN static void CreateHisto(const char *name, Int_t nbinsx, const Double_t *xbins, Int_t nbinsy,
                                               const Double_t *ybins, TString xtitle = "", TString ytitle = "")
{
    std::string dummy = Form("h2_%s", name);
 ...
 */
SUPPRESS_NOT_USED_WARN static void CreateNSparse(const char *name, int dimension, int *bins, double *xmin, double *xmax,
...
{
    TEfficiency *tmpeff =
        new TEfficiency(Form("eff_%s", name), Form("%s;%s;%s", name, xtitle, "#epsilon"), nbinsx, xbins);
 ...
 */
SUPPRESS_NOT_USED_WARN static void CreateEff(const char *name, Int_t nbinsx, Double_t xlow, Double_t xup,
                                             const char *xtitle = "", bool weighted = false)
{
    TEfficiency *tmpeff =
        new TEfficiency(Form("eff_%s", name), Form("%s;%s;%s", name, xtitle, "#epsilon"), nbinsx, xlow, xup);
    if (weighted)
    {
 ...
 * \param[in] ytitle Optinal title of the y-axis (DEFAULT = "")
 */
SUPPRESS_NOT_USED_WARN static void CreateEff(const char *name, Int_t nbinsx, Double_t xlow, Double_t xup, Int_t nbinsy,
                                             Double_t ylow, Double_t yup, const char *xtitle = "",
                                             const char *ytitle = "")
{
    TEfficiency *tmpeff = new TEfficiency(Form("eff_%s", name), Form("%s;%s;%s;%s", name, xtitle, ytitle, "#epsilon"),
 ...
 * \param[in] ytitle Optinal title of the y-axis (DEFAULT = "")
 */
SUPPRESS_NOT_USED_WARN static void CreateProf(const char *name, Int_t nbinsx, Double_t xlow, Double_t xup,
...
static void Fill(Int_t n_histo, const char *name, double value, double weight)
{
    ...
    {
        std::cerr << "(Fill) No hist: " << Form("h1_%d_%s", n_histo, name) << " in map " << n_histo
                  << " size is : " << histo.size() << "   " << histo.max_size() << std::endl;
    }
}
 ...
 *           //HistClass::WriteAll(TString::Format("_%s_", channel),TString::Format("%s:_%c_", channel,
 * n_satge),TString::Format("sys"));
 *           //file1->cd();
 ...
 * contain the given string in there name. The written efficiencies also have to contain a list of strings that are
 * sepe- rated by a ':'. \param[in] name String that all efficiency names that should be written contain \param[in]
 * contains_i String that of names (seperated by ':') that the efficiency name should contain
 */
 ...
 */
SUPPRESS_NOT_USED_WARN static void NameBins(const char *name, const uint n_bins_x, TString *x_bin_names,
                                            const uint n_bins_y, TString *y_bin_names)
{
    std::string dummy = Form("h2_%s", name);
