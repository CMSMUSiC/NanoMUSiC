...
PROCESS_GROUP_STYLES = {
    ...
    "QCD":              HistStyle( label=r"Multi-Jet",                          color= ROOT.TColor.GetColor( '#4daf4a' ), colorhex='#4daf4a'  ),
    ...
    "Gamma":            HistStyle( label=r"$\gamma$ + Jets", html="&gamma+Jets",color= ROOT.TColor.GetColor( '#337a33' ), colorhex='#337a33'),
    "DiPhoton":         HistStyle( label=r"$\gamma \gamma$", html="&gamma&gamma",color= ROOT.TColor.GetColor( '#b683eb' ), colorhex='#b683eb'),
    "GG":               HistStyle( label=r"$\gamma \gamma$", html="&gamma&gamma",color= ROOT.TColor.GetColor( '#b683eb' ), colorhex='#b683eb'),
    "TTbar":            HistStyle( label=r"t $\bar{t}$", html="t&tmacr;",             color= ROOT.TColor.GetColor( '#ffdb1a' ), colorhex= '#ffdb1a'),
    "TTbarV":           HistStyle( label=r"t $\bar{t} + V$",html="tt&tmacr;+V",        color= ROOT.TColor.GetColor( '#ccaf14' ), colorhex='#ccaf14'),
    "Top":              HistStyle( label=r"Single-Top",                         color= ROOT.TColor.GetColor( '#e41a1c' ), colorhex='#e41a1c'),
    "TTTT":             HistStyle( label=r"$t \bar{t} t \bar{t}$",html="tt&tmacr;",    color= ROOT.TColor.GetColor( '#99830f' ), colorhex='#99830f'),
    "TTG":              HistStyle( label=r"t $\bar{t} + \gamma$", html="tt&tmacr;+&gamma", color= ROOT.TColor.GetColor( '#ccaf14' ), colorhex= '#ccaf14' ),
    ...
    "tZQ":              HistStyle( label=r"tZq",                 color= ROOT.TColor.GetColor( '#e63032' ), colorhex='#e63032' ),
    "TZQ":              HistStyle( label=r"TZQ",                 color= ROOT.TColor.GetColor( '#e63032' ), colorhex='#e63032' ),
    "ZG":               HistStyle( label=r"Z+$\gamma$",          color= ROOT.TColor.GetColor( '#c194ee' ), colorhex='#c194ee' ),
    "DiBoson":          HistStyle( label=r"Di-Boson",            color= ROOT.TColor.GetColor( '#984ee3' ), colorhex= '#984ee3' ),
    "TriBoson":         HistStyle( label=r"Tri-Boson",           color= ROOT.TColor.GetColor( '#793E82' ), colorhex='#793E82' ),
    "Multi-Boson":      HistStyle( label=r"Multi-Boson",         color= ROOT.TColor.GetColor( '#984ee3' ), colorhex= '#984ee3' ), 
    "WW":               HistStyle( label=r"WW",                  color= ROOT.TColor.GetColor( '#984ee3' ), colorhex= '#984ee3'),
    "WZ":               HistStyle( label=r"WZ",                  color= ROOT.TColor.GetColor( '#793eb5' ), colorhex= '#793eb5'),
    "ZZ":               HistStyle( label=r"ZZ",                  color= ROOT.TColor.GetColor( '#5b2e88' ), colorhex= '#5b2e88'),
    "ZToInvisible":     HistStyle( label=r"Z->$\nu\nu$",         color= ROOT.TColor.GetColor( '#f6ba7f' ), colorhex= '#f6ba7f'),
    "TTW":              HistStyle( label=r"$t\bar{t}$ + W",      color= ROOT.TColor.GetColor( '#ee7600' ), colorhex= '#ee7600'),
    "WZG":              HistStyle( label=r"WZ + $\gamma$",       color= ROOT.TColor.GetColor( '#86518e' ), colorhex= '#86518e'),
    "ZToQQ":            HistStyle( label=r"Z->qq",               color= ROOT.TColor.GetColor( '#ee7600' ), colorhex= '#ee7600'),
    "TTZ":              HistStyle( label=r"$t\bar{t}$ + Z",      color= ROOT.TColor.GetColor( '#ec5e60' ), colorhex= '#ec5e60'),
    "TG":               HistStyle( label=r"t + $\gamma$",        color= ROOT.TColor.GetColor( '#9f1213' ), colorhex= '#9f1213'),
    "tG":               HistStyle( label=r"t + $\gamma$",        color= ROOT.TColor.GetColor( '#9f1213' ), colorhex= '#9f1213'),
    "WWZ":              HistStyle( label=r"WWZ",                 color= ROOT.TColor.GetColor( '#6c3775' ), colorhex= '#6c3775'),
    "WZZ":              HistStyle( label=r"WZZ",                 color= ROOT.TColor.GetColor( '#542b5b' ), colorhex= '#542b5b'),
    "TTbarTTbar":       HistStyle( label=r"$t \bar{t} t \bar{t}$", color= ROOT.TColor.GetColor( '#99830f' ), colorhex='#99830f' ),
    "HIG":              HistStyle( label=r"Higgs",                 color= ROOT.TColor.GetColor( '#48d1cc' ), colorhex='#48d1cc' ),
    "ZZZ":              HistStyle( label=r"ZZZ",                 color= ROOT.TColor.GetColor( '#3c1f41' ), colorhex='#3c1f41' ),
    "WWW":              HistStyle( label=r"WWW",                 color= ROOT.TColor.GetColor( '#793E82' ), colorhex='#793E82' ),
    "mixed":            HistStyle( label=r"Mixed",               color= 15  ),
    "Signal":           HistStyle( label=r"Signal",              color= 2, fillstyle=0 ),
    "Wprime2000":           HistStyle( label=r"W' 2000GeV (signal)",              color= ROOT.TColor.GetColor( '#cc0066'), fillstyle=0 ),
    "Wprime3000":           HistStyle( label=r"W' 3000GeV (signal)",              color= ROOT.TColor.GetColor( '#cc0066'), fillstyle=0 ),
    "Wprime4000":           HistStyle( label=r"W' 4000GeV (signal)",              color= ROOT.TColor.GetColor( '#cc0066'), fillstyle=0 ),
    "Wprime5000":           HistStyle( label=r"W' 5000GeV (signal)",              color= ROOT.TColor.GetColor( '#cc0066'), fillstyle=0 ),
