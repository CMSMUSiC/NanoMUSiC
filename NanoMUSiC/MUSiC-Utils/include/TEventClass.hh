...
class TEventClass : public TNamed
{
  ...
  private:
    ...
    template <typename B, typename T> void AddToFolder(B *parent, const char *name, std::vector<T> objects) const;

    template <typename B> void AddToFolder(B *parent, const char *name, TObject *object) const;
