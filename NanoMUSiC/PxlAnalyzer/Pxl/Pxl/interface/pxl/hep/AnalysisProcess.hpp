...
{
  public:
    AnalysisProcess() : ObjectManager()
    {
    }
    AnalysisProcess(const AnalysisProcess &original) : ObjectManager(original)
    {
    }
    explicit AnalysisProcess(const AnalysisProcess *original) : ObjectManager(original)
    {
    }
