...
namespace pxl
{
	...
	public:
		...
		Particle(const Particle &original) : Object(original), _vector(original._vector), _charge(original._charge),
											 _pdgNumber(original._pdgNumber)
		{
		}

		explicit Particle(const Particle *original) : Object(original), _vector(original->_vector),
