...
class PXL_DLL_EXPORT ObjectManager : public Object
{
  public:
    ...
    /// argument class.
    template <class objecttype> inline void getObjectsOfType(std::vector<objecttype *> &vec) const
    {
    ...
    template <class objecttype> inline objecttype *findObject(const std::string key) const
    {
    ...
    template <class objecttype> inline objecttype *findCopyOf(const Relative *original) const
    {
