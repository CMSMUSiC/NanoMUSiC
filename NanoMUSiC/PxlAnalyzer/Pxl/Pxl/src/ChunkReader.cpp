...
bool ChunkReader::readBlock(skipMode skip, infoMode checkInfo, const std::string &infoCondition)
{
...
bool ChunkReader::readHeader(readMode mode, skipMode doSkip, infoMode checkInfo, const std::string &infoCondition)
{
