...
if you'd like to replace the exception handlers SafeInt provides, define your replacement and define this.
...
{
  public:
    const static __int8 min = (-0x7f - 1);
...
{
  public:
    const static __int64 min = 0x8000000000000000LL;
...
template <typename T, typename U> class IntRegion
{
  public:
    enum
    {
        ...
        IntZone_UintLT32_UintLT32 = SafeIntCompare < T,
        U > ::isBothUnsigned &&SafeIntCompare < T,
        U > ::isBothLT32Bit,
        IntZone_Uint32_UintLT64 = SafeIntCompare < T,
        U > ::isBothUnsigned &&IntTraits<T>::is32Bit &&IntTraits<U>::isLT64Bit,
        IntZone_UintLT32_Uint32 = SafeIntCompare < T,
        U > ::isBothUnsigned &&IntTraits<T>::isLT32Bit &&IntTraits<U>::is32Bit,
        IntZone_Uint64_Uint = SafeIntCompare < T,
        U > ::isBothUnsigned &&IntTraits<T>::is64Bit,
        IntZone_UintLT64_Uint64 = SafeIntCompare < T,
        U > ::isBothUnsigned &&IntTraits<T>::isLT64Bit &&IntTraits<U>::is64Bit,
        // unsigned-signed
        IntZone_UintLT32_IntLT32 = !IntTraits<T>::isSigned && IntTraits<U>::isSigned && SafeIntCompare < T,
        U > ::isBothLT32Bit,
        ...
        // signed-signed
        IntZone_IntLT32_IntLT32 = SafeIntCompare < T,
        U > ::isBothSigned && ::SafeIntCompare < T,
        U > ::isBothLT32Bit,
        IntZone_Int32_IntLT64 = SafeIntCompare < T,
        U > ::isBothSigned &&IntTraits<T>::is32Bit &&IntTraits<U>::isLT64Bit,
        IntZone_IntLT32_Int32 = SafeIntCompare < T,
        U > ::isBothSigned &&IntTraits<T>::isLT32Bit &&IntTraits<U>::is32Bit,
        IntZone_Int64_Int64 = SafeIntCompare < T,
        U > ::isBothSigned &&IntTraits<T>::isInt64 &&IntTraits<U>::isInt64,
        IntZone_Int64_Int = SafeIntCompare < T,
        U > ::isBothSigned &&IntTraits<T>::is64Bit &&IntTraits<U>::isLT64Bit,
        IntZone_IntLT64_Int64 = SafeIntCompare < T,
        U > ::isBothSigned &&IntTraits<T>::isLT64Bit &&IntTraits<U>::is64Bit,
        // signed-unsigned
        IntZone_IntLT32_UintLT32 = IntTraits<T>::isSigned && !IntTraits<U>::isSigned && SafeIntCompare < T,
        U > ::isBothLT32Bit,
...
{
  public:
    template <typename E> static T NegativeThrow(T t)
    {
        // corner case
...
template <> class NegationAssertHelper<true>
{
  public:
...
template <> class NegationAssertHelper<false>
{
  public:
    static void BehaviorWarning()
    {
...
{
  public:
    template <typename E> static T NegativeThrow(T t) throw()
    {
...
template <typename ToType, typename FromType> class GetCastMethod
{
  public:
    ...
    {
        method =
            (IntTraits<FromType>::isBool && !IntTraits<ToType>::isBool) ? CastFromBool :
            ...
            (!IntTraits<ToType>::isSigned && IntTraits<FromType>::isSigned && sizeof(ToType) >= sizeof(FromType))
                ? CastCheckLTZero
            :
...
template <typename T, typename U> class SafeCastHelper<T, U, CastOK>
{
  public:
    ...
    template <typename E> static void CastThrow(U u, T &t)
    {
        t = (T)u;
    }
};
...
template <typename T> class SafeCastHelper<T, bool, CastFromBool>
{
  public:
    ...
    template <typename E> static void CastThrow(bool b, T &t)
    {
        t = (T)(b ? 1 : 0);
    }
};
...
template <typename T, typename U> class ModulusHelper<T, U, ComparisonMethod_Ok>
{
  public:
    ...
    template <typename E> static void ModulusThrow(const T &t, const U &u, T &result)
    {
        if (u == 0)
            E::SafeIntOnDivZero();
  ...
  public:
    enum
    {
        ...
        method = (IntRegion<T, U>::IntZone_UintLT32_UintLT32 ? MultiplicationState_CastUint
                  ...
                  : (IntRegion<T, U>::IntZone_Int32_IntLT64 || IntRegion<T, U>::IntZone_IntLT32_Int32)
                      ? MultiplicationState_CastInt64
                  ...
                  : (IntRegion<T, U>::IntZone_Int32_UintLT32 || IntRegion<T, U>::IntZone_IntLT64_Uint32)
                      ? MultiplicationState_CastInt64
...
template <typename T, typename U> class MultiplicationHelper<T, U, MultiplicationState_CastInt>
{
  public:
    ...
    template <typename E> static void MultiplyThrow(const T &t, const U &u, T &ret)
    {
        int tmp = t * u;
  ...
  public:
    ...
    static void RegMultiplyThrow(const unsigned __int64 &a, signed __int32 b, unsigned __int64 *pRet)
    {
        ...
        if (!IntrinsicMultiplyUint64(a, (unsigned __int64)b, pRet))
            E::SafeIntOnOverflow();
#else
        LargeIntRegMultiply<unsigned __int64, unsigned __int32>::template RegMultiplyThrow<E>(a, (unsigned __int32)b,
                                                                                              pRet);
#endif
    }
};
  ...
  public:
    ...
    static void RegMultiplyThrow(const unsigned __int64 &a, signed __int64 b, unsigned __int64 *pRet)
    {
        ...
        if (!IntrinsicMultiplyUint64(a, (unsigned __int64)b, pRet))
            E::SafeIntOnOverflow();
#else
        LargeIntRegMultiply<unsigned __int64, unsigned __int64>::template RegMultiplyThrow<E>(a, (unsigned __int64)b,
                                                                                              pRet);
#endif
    }
};
...
template <> class LargeIntRegMultiply<unsigned __int32, signed __int64>
{
  public:
    ...
    static void RegMultiplyThrow(unsigned __int32 a, const signed __int64 &b, unsigned __int32 *pRet)
    {
        ...
        LargeIntRegMultiply<unsigned __int32, unsigned __int64>::template RegMultiplyThrow<E>(a, (unsigned __int64)b,
                                                                                              pRet);
    }
};
...
template <> class LargeIntRegMultiply<signed __int64, unsigned __int32>
{
  public:
    ...
    static void RegMultiplyThrow(const signed __int64 &a, unsigned __int32 b, signed __int64 *pRet)
    {
        ...
        LargeIntRegMultiply<unsigned __int64, unsigned __int32>::template RegMultiplyThrow<E>((unsigned __int64)a1, b,
                                                                                              &tmp);
...
template <> class LargeIntRegMultiply<signed __int64, signed __int32>
{
  public:
    static bool RegMultiply(const signed __int64 &a, signed __int32 b, signed __int64 *pRet) throw()
    {
        ...
        if (LargeIntRegMultiply<unsigned __int64, unsigned __int32>::RegMultiply((unsigned __int64)a1,
    ...
    template <typename E> static void RegMultiplyThrow(signed __int64 a, signed __int32 b, signed __int64 *pRet)
    {
#if SAFEINT_USE_INTRINSICS
        if (!IntrinsicMultiplyInt64(a, (signed __int64)b, pRet))
            E::SafeIntOnOverflow();
...
template <> class LargeIntRegMultiply<signed __int32, signed __int64>
{
  public:
    static bool RegMultiply(signed __int32 a, const signed __int64 &b, signed __int32 *pRet) throw()
    {
        ...
        if (LargeIntRegMultiply<unsigned __int32, unsigned __int64>::RegMultiply((unsigned __int32)a,
                                                                                 (unsigned __int64)b1, &tmp))
        {
            // The unsigned multiplication didn't overflow
            if (aNegative ^ bNegative)
    ...
    template <typename E> static void RegMultiplyThrow(signed __int32 a, const signed __int64 &b, signed __int32 *pRet)
    {
#if SAFEINT_USE_INTRINSICS
        __int64 tmp;
...
template <typename T, typename U> class MultiplicationHelper<T, U, MultiplicationState_Uint64Uint64>
{
  public:
    ...
    template <typename E> static void MultiplyThrow(const unsigned __int64 &t, const unsigned __int64 &u, T &ret)
    {
        C_ASSERT(IntTraits<T>::isUint64 && IntTraits<U>::isUint64);
        unsigned __int64 t1 = t;
        unsigned __int64 u1 = u;
...
template <typename T, typename U> class MultiplicationHelper<T, U, MultiplicationState_Uint64Int64>
{
  public:
    ...
    static bool Multiply(const T &t, const U &u, T &ret) throw()
    {
        ...
        unsigned __int64 t1 = t;
        __int64 u1 = u;
        return LargeIntRegMultiply<unsigned __int64, __int64>::RegMultiply(t1, u1,
...
template <typename T, typename U> class MultiplicationHelper<T, U, MultiplicationState_Int64Uint>
{
  public:
    ...
    static bool Multiply(const T &t, const U &u, T &ret) throw()
    {
        ...
        __int64 t1 = t;
        return LargeIntRegMultiply<__int64, unsigned __int32>::RegMultiply(t1, (unsigned __int32)u,
                                                                           reinterpret_cast<__int64 *>(&ret));
    }
    ...
    template <typename E> static void MultiplyThrow(const T &t, const U &u, T &ret)
    {
        C_ASSERT(IntTraits<T>::isInt64);
        __int64 t1 = t;
        LargeIntRegMultiply<__int64, unsigned __int32>::template RegMultiplyThrow<E>(t1, (unsigned __int32)u,
                                                                                     reinterpret_cast<__int64 *>(&ret));
    }
};
...
template <typename T, typename U> class MultiplicationHelper<T, U, MultiplicationState_Int64Int>
{
  public:
    ...
    template <typename E> static void MultiplyThrow(const __int64 &t, U u, T &ret)
    {
        C_ASSERT(IntTraits<T>::isInt64);
        __int64 t1 = t;
        LargeIntRegMultiply<__int64, __int32>::template RegMultiplyThrow<E>(t1, (__int32)u,
                                                                            reinterpret_cast<__int64 *>(&ret));
    }
};
...
template <typename T, typename U> class MultiplicationHelper<T, U, MultiplicationState_IntUint64>
{
  public:
    ...
    template <typename E> static void MultiplyThrow(T t, const unsigned __int64 &u, T &ret)
    {
        C_ASSERT(IntTraits<U>::isUint64);
        unsigned __int64 u1 = u;
        __int32 tmp;
...
template <typename T, typename U> class MultiplicationHelper<T, U, MultiplicationState_Int64Uint64>
{
  public:
    ...
    template <typename E> static void MultiplyThrow(const __int64 &t, const unsigned __int64 &u, T &ret)
    {
        C_ASSERT(IntTraits<T>::isInt64 && IntTraits<U>::isUint64);
        __int64 t1 = t;
        unsigned __int64 u1 = u;
        LargeIntRegMultiply<__int64, unsigned __int64>::template RegMultiplyThrow<E>(t1, u1,
                                                                                     reinterpret_cast<__int64 *>(&ret));
    }
};
...
template <typename T, typename U> class MultiplicationHelper<T, U, MultiplicationState_IntInt64>
{
  public:
    ...
    template <typename E> static void MultiplyThrow(T t, const U &u, T &ret)
    {
        C_ASSERT(IntTraits<U>::isInt64);
        __int64 u1 = u;
        __int32 tmp;
...
template <typename T, typename U> class DivisionHelper<T, U, DivisionState_OK>
{
  public:
    ...
    template <typename E> static void DivideThrow(const T &t, const U &u, T &result)
    {
        if (u == 0)
            E::SafeIntOnDivZero();
...
template <typename T, typename U> class DivisionHelper<T, U, DivisionState_SignedUnsigned64>
{
  public:
    ...
    template <typename E> static void DivideThrow(const T &t, const unsigned __int64 &u, T &result)
    {
        C_ASSERT(IntTraits<U>::isUint64);
...
template <typename T, typename U> class AdditionHelper<T, U, AdditionState_CastIntCheckMax>
{
  public:
    ...
    template <typename E> static void AdditionThrow(const T &lhs, const U &rhs, T &result)
    {
        // 16-bit or less unsigned addition
        __int32 tmp = lhs + rhs;
...
template <typename T, typename U> class AdditionHelper<T, U, AdditionState_CastInt64CheckOverflowMinMax>
{
  public:
    static bool Addition(const T &lhs, const U &rhs, T &result) throw()
    {
        ...
        if (AdditionHelper<__int64, __int64, AdditionState_CastInt64CheckOverflow>::Addition((__int64)lhs, (__int64)rhs,
                                                                                             tmp) &&
    ...
    template <typename E> static void AdditionThrow(const T &lhs, const U &rhs, T &result)
    {
        ...
        AdditionHelper<__int64, __int64, AdditionState_CastInt64CheckOverflow>::AdditionThrow<E>((__int64)lhs,
                                                                                                 (__int64)rhs, tmp);
...
template <typename T, typename U> class AdditionHelper<T, U, AdditionState_ManualCheckInt64Uint64>
{
  public:
    ...
    template <typename E> static void AdditionThrow(const __int64 &lhs, const unsigned __int64 &rhs, T &result)
    {
        C_ASSERT(IntTraits<T>::isInt64 && IntTraits<U>::isUint64);
        // rhs is unsigned __int64, lhs __int64
        unsigned __int64 tmp = (unsigned __int64)lhs + rhs;
    ...
    enum
    {
        ...
        method =
            ((IntRegion<T, U>::IntZone_UintLT32_UintLT32 || (IntRegion<T, U>::IntZone_Uint32_UintLT64) ||
             ...
             : (IntRegion<T, U>::IntZone_Int32_IntLT64 || IntRegion<T, U>::IntZone_IntLT32_Int32)
                 ? SubtractionState_CastInt64CheckMinMax
             : (IntRegion<T, U>::IntZone_Int64_Int || IntRegion<T, U>::IntZone_Int64_Int64) ? SubtractionState_Int64Int
    ...
    enum
    {
        ...
        method =
            ((IntRegion<T, U>::IntZone_UintLT32_UintLT32 || (IntRegion<T, U>::IntZone_Uint32_UintLT64) ||
             ...
             : (IntRegion<T, U>::IntZone_Int32_IntLT64 || IntRegion<T, U>::IntZone_IntLT32_Int32)
                 ? SubtractionState_CastInt64CheckMinMax2
             : (IntRegion<T, U>::IntZone_Int64_Int || IntRegion<T, U>::IntZone_Int64_Int64) ? SubtractionState_Int64Int2
...
template <typename T, typename U> class SubtractionHelper<T, U, SubtractionState_BothUnsigned>
{
  public:
    ...
    template <typename E> static void SubtractThrow(const T &lhs, const U &rhs, T &result)
    {
        // both are unsigned - easy case
        if (rhs <= lhs)
        {
...
template <typename T, typename U> class SubtractionHelper<T, U, SubtractionState_BothUnsigned2>
{
  public:
    ...
    template <typename E> static void SubtractThrow(const T &lhs, const U &rhs, U &result)
    {
        // both are unsigned - easy case
        if (rhs <= lhs)
        {
...
template <typename U, typename T> class SubtractionHelper<U, T, SubtractionState_CastIntCheckMinMax2>
{
  public:
    ...
    template <typename E> static void SubtractThrow(const U &lhs, const T &rhs, T &result)
    {
        // both values are 16-bit or less
        // rhs is signed, so could end up increasing or decreasing
        __int32 tmp = lhs - rhs;
...
template <typename T, typename U> class SubtractionHelper<T, U, SubtractionState_Int64Uint64>
{
  public:
    ...
    template <typename E> static void SubtractThrow(const __int64 &lhs, const unsigned __int64 &rhs, T &result)
    {
        C_ASSERT(IntTraits<T>::isInt64 && IntTraits<U>::isUint64);
        // if we subtract, and it gets larger, there's a problem
        // Perform test as unsigned to prevent unwanted optimizations
...
template <typename T, typename U> inline bool SafeEquals(const T t, const U u) throw()
{
...
template <typename T, typename U> inline bool SafeGreaterThan(const T t, const U u) throw()
{
    return GreaterThanTest<T, U, ValidComparison<T, U>::method>::GreaterThan(t, u);
}

template <typename T, typename U> inline bool SafeGreaterThanEquals(const T t, const U u) throw()
{
    return !GreaterThanTest<U, T, ValidComparison<U, T>::method>::GreaterThan(u, t);
}

template <typename T, typename U> inline bool SafeLessThan(const T t, const U u) throw()
{
    return GreaterThanTest<U, T, ValidComparison<U, T>::method>::GreaterThan(u, t);
}

template <typename T, typename U> inline bool SafeLessThanEquals(const T t, const U u) throw()
{
    return !GreaterThanTest<T, U, ValidComparison<T, U>::method>::GreaterThan(t, u);
}

template <typename T, typename U> inline bool SafeModulus(const T &t, const U &u, T &result) throw()
{
    return (ModulusHelper<T, U, ValidComparison<T, U>::method>::Modulus(t, u, result) == SafeIntNoError);
}

template <typename T, typename U> inline bool SafeMultiply(T t, U u, T &result) throw()
{
...
template <typename T, typename U> inline bool SafeAdd(T t, U u, T &result) throw()
{
    return AdditionHelper<T, U, AdditionMethod<T, U>::method>::Addition(t, u, result);
}

template <typename T, typename U> inline bool SafeSubtract(T t, U u, T &result) throw()
{
...
template <typename T, typename E = SafeIntDefaultExceptionHandler> class SafeInt
{
  public:
    ...
    template <typename U> SafeInt<T, E> &operator*=(SafeInt<U, E> rhs)
    {
        MultiplicationHelper<T, U, MultiplicationMethod<T, U>::method>::template MultiplyThrow<E>(m_int, rhs.Ref(),
                                                                                                  m_int);
        return *this;
    }
...
#define ShiftAssert(x) assert(x)
  ...
  private:
    ...
    template <typename U> static SafeInt<T, E> SafeTtoI(U *input)
    {
        U *tmp = input;
        SafeInt<T, E> s;
        bool negative = false;
...
template <typename P> SafeInt<ptrdiff_t, SafeIntDefaultExceptionHandler> SafePtrDiff(const P *p1, const P *p2)
{
...
template <typename T, typename U, typename E> bool operator<(U lhs, SafeInt<T, E> rhs) throw()
{
    return GreaterThanTest<T, U, ValidComparison<T, U>::method>::GreaterThan((T)rhs, lhs);
}

template <typename T, typename U, typename E> bool operator<(SafeInt<U, E> lhs, SafeInt<T, E> rhs) throw()
{
...
template <typename T, typename U, typename E> bool operator>(SafeInt<T, E> lhs, SafeInt<U, E> rhs) throw()
{
...
template <typename T, typename E> bool operator==(bool lhs, SafeInt<T, E> rhs) throw()
{
...
template <typename T, typename U, typename E> class ModulusSimpleCaseHelper<T, U, E, true>
{
  public:
...
template <typename T, typename U, typename E> class ModulusSimpleCaseHelper<T, U, E, false>
{
  public:
    static bool ModulusSimpleCase(U /*lhs*/, SafeInt<T, E> /*rhs*/, SafeInt<T, E> & /*result*/)
    {
...
// +=
template <typename T, typename U, typename E> T &operator+=(T &lhs, SafeInt<U, E> rhs)
{
    T ret(0);
...
template <typename T, typename U, typename E> T &operator&=(T &lhs, SafeInt<U, E> rhs) throw()
{
...
// Left shift
template <typename T, typename U, typename E> SafeInt<U, E> operator<<(U lhs, SafeInt<T, E> bits) throw()
{
...
// Bitwise &
template <typename T, typename U, typename E> SafeInt<T, E> operator&(U lhs, SafeInt<T, E> rhs) throw()
{
