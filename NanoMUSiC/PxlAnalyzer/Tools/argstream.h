...
namespace 
{
   class argstream; //forward declaration, used later


   //===================parameter section===========================================================

   template<class T> class ValueHolder; //forward declaration, necessary for the next forward declaration
  
   template<typename T> argstream& operator>>(argstream&, const ValueHolder< T >&); //forward declaration, used in the next declaration
   ...
   template< class T > ValueHolder< T > parameter( char s,
                                                   const char* l,
                                                   T& b,
                                                   const char* desc = "",
                                                   bool mandatory = true )
   ...
   template< class T > ValueHolder< T > parameter( const char* l,
                                                   T& b,
                                                   const char* desc = "",
                                                   bool mandatory = true )
      {
   ...
   //--------------functions for options/flags--------------------------
   OptionHolder option( char s,
                        const char* l,
                        bool& b,
                        const char* desc = "" )
      {
   ...
   template<class T,class O> class ValuesHolder;

   template<class T,class O> argstream& operator>>( argstream& s, const ValuesHolder< T, O >& v);
   ...
   //--------------functions for options/flags--------------------------
   template< class T, class O > ValuesHolder< T, O > values( const O& o,
                                                             const char* desc = "",
                                                             int len = -1 )
      {
