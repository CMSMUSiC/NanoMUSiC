...
JetResolution::JetResolution(
    ...
    std::string const &jetType) : m_rand(),
                                  m_resolution_correction_set(correction::CorrectionSet::from_file(Tools::AbsolutePath(config.GetItem<std::string>(jetType + ".JSONFile"))))
{
