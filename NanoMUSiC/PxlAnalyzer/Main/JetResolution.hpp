...
class JetResolution
{
  public:
    ...
    double getJetResolutionCorrFactor(pxl::Particle const *recJet, pxl::Particle const *genJet, double const npv,
                                      double const rho, int const updown);
    pxl::Particle *matchGenJet(const pxl::Particle *rec_jet, const std::vector<pxl::Particle *> &gen_jets,
