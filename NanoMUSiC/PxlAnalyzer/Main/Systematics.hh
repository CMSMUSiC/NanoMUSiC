...
private:
   ...
   void shiftBJetsSF2A( std::string const& partName,
   ...
   std::pair<double,double> getObjScaleShift(pxl::Particle* obj,
                                             std::string const& partName);
   std::pair<double,double> getObjResolutionShift(pxl::Particle* obj,
                                                  std::string const& partName);
   void shiftObjAndMET(std::string const& partName,
                       std::string const& shiftType );
   std::pair<double,double> getObjShiftValue(pxl::Particle* obj,
                                             std::string const& partName,
                                             std::string const& shiftType);
   ...
   void shiftParticle(pxl::EventView* eview,
