#include "PhotonEffectiveArea.hpp"
...
PhotonEffectiveArea::PhotonEffectiveArea(Tools::MConfig const &config)
    :
      ...
      m_eta_EAchargedHadrons_map(config, "Gamma.EffArea.eta_edges", "Gamma.EffArea.EA_charged_hadrons",
                                 "Gamma.EffArea.abs_eta"),
      m_eta_EAneutralHadrons_map(config, "Gamma.EffArea.eta_edges", "Gamma.EffArea.EA_neutral_hadrons",
                                 "Gamma.EffArea.abs_eta"),
      m_eta_EAphotons_map(config, "Gamma.EffArea.eta_edges", "Gamma.EffArea.EA_photons", "Gamma.EffArea.abs_eta")
{
}
