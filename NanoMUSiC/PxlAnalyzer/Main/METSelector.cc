...
METSelector::METSelector(const Tools::MConfig &cfg, OldNameMapper *globalOldNameMap) : // Add parent constructor
...
int METSelector::passObjectSelection(pxl::Particle *met,
                                     double const metRho,
