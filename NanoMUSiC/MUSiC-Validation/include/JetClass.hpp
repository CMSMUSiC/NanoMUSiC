...
class JetClass
{
  public:
    ...
    // constructor
    JetClass(const std::string &output_path, const std::string c_name);

    // fill histograms
    auto fill(VecOps::RVec<float> jets_pt, VecOps::RVec<float> jets_eta, VecOps::RVec<float> jets_phi, VecOps::RVec<float> jets_mass,
