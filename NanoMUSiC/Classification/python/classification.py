...
def launch_parallel(
    ...
    parallel_resume_loop(
        ...
        parallel_command="cd classification_outputs && parallel --joblog job.log --retry-failed --memfree 50G -j ___NUM_CPUS___ --eta --progress --noswap  'python3 {} > {/.}.stdout 2> {/.}.stderr' :::: ../classification_jobs/inputs_parallel.txt".replace(
