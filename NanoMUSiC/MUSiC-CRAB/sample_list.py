...
def make_sample_list(xSection_file_path, global_now, sample, year):
    input_file = ""
    ...
    for process_name in xsections:
        if (process_name == sample) or (sample == ""):
            ...
            if "das_name_2016APV" in xsections[process_name] and (
                "das_name_2016APV" == f"das_name_{year}" or year == ""
            ):
            ...
            if "das_name_2016" in xsections[process_name] and (
                "das_name_2016" == f"das_name_{year}" or year == ""
            ):
                for idx_das_name, das_name in enumerate(
            ...
            if "das_name_2017" in xsections[process_name] and (
                "das_name_2017" == f"das_name_{year}" or year == ""
            ):
                for idx_das_name, das_name in enumerate(
            ...
            if "das_name_2018" in xsections[process_name] and (
                "das_name_2018" == f"das_name_{year}" or year == ""
            ):
                for idx_das_name, das_name in enumerate(
