...
function main()
    ...
    for filter = [one_muon, two_muons, two_electrons, one_muon_one_electron, one_muon_or_one_electron_and_one_tau, three_leptons_opossite_flavor, three_muons, three_electrons, multi_lepton_no_tau, multi_lepton_with_tau,
